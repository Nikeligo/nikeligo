...
#define B_FLAG_NO_BAG_USE           FLAG_UNUSED_0x022     // If this flag is set, the ability to use the bag in battle is disabled.
#define B_FLAG_NO_CATCHING          0     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_UNUSED_0x021     // If this flag is set, the player's mons will be controlled by the ai next battles.
